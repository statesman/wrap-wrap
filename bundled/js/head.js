...
window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"aaf23b031f","agent":"js-agent.newrelic.com/nr-632.min.js","transactionName":"MQYHNRZYCkZVBxcKVghMIxQKWhBcWwpMAVwSFwATB1gHXVFKFQpcERBfIwFNEFBGMgoGTkgEABU=","applicationID":"2789804","errorBeacon":"bam.nr-data.net","applicationTime":8};
flipper = new Object();
...
0),y=/^true$/.test("")?!0:!1,z=c("0.1",0),A=c("0.01",0),B=c("0.01",0),C=c("0.01",0),D=c("1",0),E=c("",.001),F=c("0.01",0),G=c("0.0",0),H=c("0.05",0),I=c("0.5",0),J=c("0.0",
0),K=c("0.5",0),L=c("0.0",0),M=c("0.0001",0),N=c("0.0001",0);var O=/^true$/.test("false")?!0:!1;var P=function(){return a.googletag||(a.googletag={})},Q=function(b,e){var d=P();d.hasOwnProperty(b)||(d[b]=e)};var R={};R["#1#"]=h("","pagead2.googlesyndication.com");R["#2#"]=h("","pubads.g.doubleclick.net");R["#3#"]=h("","securepubads.g.doubleclick.net");R["#4#"]=h("","partner.googleadservices.com");R["#6#"]=function(b){try{for(var e=null;e!=b;e=b,b=b.parent)switch(b.location.protocol){case "https:":return!0;case "http:":case "file:":return!1}}catch(d){}return!0}(window);R["#7#"]=k;R["#10#"]=n;R["#11#"]=p;
R["#12#"]=m;R["#13#"]=q;R["#16#"]=r;R["#17#"]=t;R["#18#"]=u;R["#20#"]=l;R["#23#"]=v;R["#24#"]=w;R["#27#"]=x;R["#28#"]=z;R["#29#"]=A;R["#31#"]=B;R["#33#"]=h("","pagead2.googlesyndication.com");R["#34#"]=D;R["#36#"]=y;R["#37#"]=C;R["#38#"]=E;R["#39#"]="108809042";R["#40#"]=F;R["#41#"]=G;R["#50#"]=H;R["#42#"]=I;R["#43#"]=J;R["#44#"]=K;R["#45#"]=L;R["#46#"]=O;R["#47#"]=M;R["#48#"]=N;R["#49#"]=(new Date).getTime();Q("_vars_",R);var S=function(){return"68r2"};Q("getVersion",S);var T=document;Q("cmd",[]);
